...
try {
    ...
    // Supprime le defi
    $deleteDefiQuery = "UPDATE FR_DEFI SET ACTIF = 0 WHERE ID = " . $defiId . ";";
    query_mysql($mysqli, $deleteDefiQuery, "Impossible de supprimer le defis avec la description '" . getSummary($description) . "'.");

    $response->message = "Le defi '" . getSummary($description) . "' a ete supprime.";
